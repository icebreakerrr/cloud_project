...
public class level_selectController implements Initializable {
    ...
    public void go_to_lawn_1() throws Exception
    {
    ...
    public void go_to_lawn_2() throws Exception
    {

        Pane pane = FXMLLoader.load(getClass().getResource("../lawn/lawn2.fxml"));
        level_select_pane.getChildren().setAll(pane);
        mediaPlayer2.pause();
        mediaPlayer2.stop();
    }

    public void go_to_lawn_3() throws Exception
    {

        Pane pane = FXMLLoader.load(getClass().getResource("../lawn/lawn3.fxml"));
        level_select_pane.getChildren().setAll(pane);
        mediaPlayer2.pause();
        mediaPlayer2.stop();
    }

    public void go_to_lawn_4() throws Exception
    {

        Pane pane = FXMLLoader.load(getClass().getResource("../lawn/lawn4.fxml"));
        level_select_pane.getChildren().setAll(pane);
        mediaPlayer2.pause();
        mediaPlayer2.stop();
    }

    public void go_to_lawn_5() throws Exception
    {

        Pane pane = FXMLLoader.load(getClass().getResource("../lawn/lawn5.fxml"));
        level_select_pane.getChildren().setAll(pane);
        mediaPlayer2.pause();
        mediaPlayer2.stop();
    }
